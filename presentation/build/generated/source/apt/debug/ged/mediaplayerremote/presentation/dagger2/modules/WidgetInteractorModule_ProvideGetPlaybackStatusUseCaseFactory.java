...
public final class WidgetInteractorModule_ProvideGetPlaybackStatusUseCaseFactory implements Factory<UseCase> {
  ...
  public WidgetInteractorModule_ProvideGetPlaybackStatusUseCaseFactory(WidgetInteractorModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<PlaybackStatusProxy> playbackStatusProxyProvider) {  
    assert module != null;
    this.module = module;
  ...
  @Override
  public UseCase get() {  
    UseCase provided = module.provideGetPlaybackStatusUseCase(threadExecutorProvider.get(), postExecutionThreadProvider.get(), playbackStatusProxyProvider.get());
    if (provided == null) {
  ...
  public static Factory<UseCase> create(WidgetInteractorModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<PlaybackStatusProxy> playbackStatusProxyProvider) {  
    return new WidgetInteractorModule_ProvideGetPlaybackStatusUseCaseFactory(module, threadExecutorProvider, postExecutionThreadProvider, playbackStatusProxyProvider);
  }
}
