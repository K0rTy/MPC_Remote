...
public final class WidgetInteractorModule_ProvideRewindUseCaseFactory implements Factory<UseCase> {
  ...
  public WidgetInteractorModule_ProvideRewindUseCaseFactory(WidgetInteractorModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<CommandDispatcher> commandDispatcherProvider) {  
    assert module != null;
    this.module = module;
  ...
  @Override
  public UseCase get() {  
    UseCase provided = module.provideRewindUseCase(threadExecutorProvider.get(), postExecutionThreadProvider.get(), commandDispatcherProvider.get());
    if (provided == null) {
  ...
  public static Factory<UseCase> create(WidgetInteractorModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<CommandDispatcher> commandDispatcherProvider) {  
    return new WidgetInteractorModule_ProvideRewindUseCaseFactory(module, threadExecutorProvider, postExecutionThreadProvider, commandDispatcherProvider);
  }
}
